                ...
                <table className="w-3/4 font-body border-separate border-spacing-4">
                    <tbody>
                        {[
                            ...
                            { label: "Bekerja : Penghasilan", field: "bekerja_penghasilan" },
                        ].map(({ label, field, type }, index) => (
                            <tr key={index}>
                                <td className="w-[63%] h-full py-2">
                                    <label>{label}</label>
                                </td>
                                <td className="w-[37%] h-full py-2">
                                    {type === "date" ? (
                                        <DatePicker
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-lg text-black">{getUnit(field)}</span>
                                            <TextInput
