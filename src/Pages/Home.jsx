        ...
        <div className="flex flex-col justify-center items-center bg-gradient-to-b from-gray-600 to-gray-900 w-screen h-screen">
            <div className="text-white flex flex-col justify-center items-center ">
                ...
                <div className="flex flex-col items-center mt-6 w-screen">
                    <Link to={"/siswa/"} className="block font-body font-bold bg-blue-600 text-center w-[715px] hover:bg-[#D9D9D9] py-3 hover:text-black rounded-md text-white my-1 text-sm">Masuk sebagai Siswa</Link>
                    <Link to={"/admin/"} className="block font-body font-bold bg-blue-600 text-center w-[715px] hover:bg-[#D9D9D9] py-3 hover:text-black rounded-md text-white my-1 text-sm">Masuk sebagai Admin</Link>
                </div>
            </div>
        </div>
    )
